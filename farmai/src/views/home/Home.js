...
import { PiCameraBold, PiNotification, PiNotificationBold, PiPlant } from "react-icons/pi";
  ...
  const features = [
    {
      ...
      icon:<WiDayCloudy size={"35px"} color="white" style={{marginTop:"14px"}} />,
    ...
    },
    {
      ...
      icon:<PiPlant size={"30px"} color="white" style={{marginTop:"15px"}} />,
    ...
    },
    {
      ...
      icon: <PiCameraBold size={"30px"} color="white" style={{marginTop:"15px"}} />,
    ...
    },
    {
      ...
      icon:<PiNotification size={"30px"} color="white" style={{marginTop:"15px"}} />,
  ...
  return (
    <div className="home-container">
      <div className="hero-container position-relative text-center text-white">
        ...
        <div className="hero-content position-absolute top-50 start-50 translate-middle w-100">
          ...
          <div className="d-flex justify-content-center gap-3 mt-4 flex-wrap">
            ...
            <button className="btn btn-light px-4 py-2 fw-bold d-flex align-items-center gap-2" onClick={()=>{
                      navigate("/chat");
      ...
      <div className="container py-5 features-section">
        <div className="text-center mb-4">
          ...
          <p className="text-muted">
            Discover the most beautiful and intuitive farming tools <br/>designed
            with love for modern agriculture
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            <div key={index} className="col-12 col-md-6 col-lg-3">
              <div className="card h-80 shadow-sm border-1 rounded-5  text-center">
                ...
                <button className="btn btn-success w-100 fw-bold rounded-5" onClick={()=>{
      ...
      <div className="justify-content-center text-center p-5">
          ...
          <p className="lead mt-2">
          Join the agricultural revolution today. Experience the power of AI-driven <br/> farming and watch your operations transform with intelligent technology.
          </p>
          <div className="d-flex justify-content-center gap-3 mt-4 flex-wrap">
            <button className="btn btn-success px-4 py-2 fw-bold"  onClick={()=>{
                      navigate("/crop");
        ...
        <div className="container">
          <div className="row justify-content-center">
            ...
            <div className="col-md-3">
              <div>
                <h3 className="mb-2 text-center">
                  <span role="img" aria-label="leaf">🌱</span> FarmAI
                </h3>
                <p className="text-center ">Smart Agriculture</p>
                <p className="text-white" style={{ fontSize: '0.9rem',color:"white"}}>
                  Revolutionizing agriculture with cutting-edge AI technology for sustainable and profitable farming worldwide.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-3 mb-2 mb-md-0">
             ...
             <li className="mb-2"><a href="/disease" className="text-white text-decoration-none">AI Detection</a></li>
             <li className="mb-2"><a href="/chat" className="text-white text-decoration-none">Assistant</a></li>
             <li className="mb-2"><a href="/notifications" className="text-white text-decoration-none">Alerts</a></li>
             </ul>
            </div>
            <div className="col-md-3 mb-2 mb-md-0">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2"><a href="#" className="text-white text-decoration-none">API Reference</a></li>
                <li className="mb-2"><a href="#" className="text-white text-decoration-none">Case Studies</a></li>
            ...
            <div className="col-md-3 mb-2 mb-md-0">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2"><a href="#" className="text-white text-decoration-none">Status</a></li>
              </ul>
            </div>
          </div>
        </div>
